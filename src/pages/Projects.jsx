...
const Projects = () => {
  return (
      ...
      <section id='projects' className='w-[90vw] mx-auto mt-8'>
                 <Tag tagName="Work"/>
                 <Text textAlign={'center'} padding={'10px'}>Some of the noteworthy projects I have built:</Text>
        ...
        <ProjectsDisplay img={hms} text={'Introducing a comprehensive hostel management system designed to optimize your daily tasks and enhance overall efficiency. Built using cutting-edge technologies like React, TailwindCSS, Redux Toolkit, React Router Dom, Express.js, MongoDB, JWT, Bcrypt, and Mongoose, my system offers a user-friendly interface and powerful features to streamline your operations.'} projectTitle={'Hostel Management System'} d={'none'} githubLink={'https://github.com/jib2004/Hostel-Management-System'}/>
      </section>
