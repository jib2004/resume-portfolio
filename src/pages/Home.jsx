    ...
    <App>
      <Box w={'100vw'} h={{xl:'100vh'}} display={'flex'} alignItems={{md:'center'}} justifyContent={'space-around'} flexDirection={{base:'column-reverse',xl:'row'}}>
        <Box w={{xl:'606px'}}>
            ...
            <Box w={{base:'90vw',md:'auto'}} textAlign={{base:'center',md:'start'}}>
                ...
                <Box display={'flex'}  alignItems={'center'} gap={'15px'} justifyContent={{base:"center",xl:"start"}} paddingTop={'10px'} paddingBottom={'10px'}>
                  <Button w={{base:'150px',md:'205px'}} background={'#008AAA'} color={'#fff'}><a href={resume} download className='w-full h-full flex items-center justify-center'>Resume</a> </Button>
                  <Button onClick={projectSection} w={{base:'150px',md:'205px'}} background={'#fff'} border={'2px'} borderColor={'#008AAA'} color={'#008AAA'}>See My Projects</Button>
                </Box>
            </Box>
        </Box>
